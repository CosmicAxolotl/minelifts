...
particle minecraft:entity_effect{color:[0.00784313725, 0.9294117647, 0.22352941176, 1]} ~ ~0.3 ~ 0.01 0.01 0.01 2 3 normal @a
...
execute store result score #$.tmp.displace ca.ml.arc_glm.fun run data get storage ca:ram stack[-1].transformation.translation[1] 1000
scoreboard players add #$.tmp.displace ca.ml.arc_glm.fun 500
execute store result storage ca:ram stack[-1].transformation.translation[1] float 0.001 run scoreboard players get #$.tmp.displace ca.ml.arc_glm.fun
