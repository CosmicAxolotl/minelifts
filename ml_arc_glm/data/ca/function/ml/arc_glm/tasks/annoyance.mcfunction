...
execute if entity @s[tag=!awaken] \
    unless entity @a[gamemode=!creative,gamemode=!spectator,distance=..16] run return fail

execute if entity @s[tag=awaken] \
    unless entity @a[gamemode=!creative,gamemode=!spectator,distance=..64] run return fail
