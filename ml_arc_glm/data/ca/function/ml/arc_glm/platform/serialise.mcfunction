...
execute store result storage ca:ram stack[-1].structure.translation[0] float 0.001 run \
    scoreboard players get #$.translation.x ca.ml.arc_glm.fun
execute store result storage ca:ram stack[-1].structure.translation[1] float 0.001 run \
    scoreboard players get #$.translation.y ca.ml.arc_glm.fun
execute store result storage ca:ram stack[-1].structure.translation[2] float 0.001 run \
