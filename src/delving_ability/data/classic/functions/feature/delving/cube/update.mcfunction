...
execute if score face.north ml.fun matches -16..-1 run scoreboard players operation face.north ml.fun *= #-1 ml.fun
execute if score face.south ml.fun matches -16..-1 run scoreboard players operation face.south ml.fun *= #-1 ml.fun
execute if score face.west ml.fun matches -16..-1 run scoreboard players operation face.west ml.fun *= #-1 ml.fun
execute if score face.east ml.fun matches -16..-1 run scoreboard players operation face.east ml.fun *= #-1 ml.fun
execute if score face.up ml.fun matches -16..-1 run scoreboard players operation face.up ml.fun *= #-1 ml.fun
execute if score face.down ml.fun matches -16..-1 run scoreboard players operation face.down ml.fun *= #-1 ml.fun
