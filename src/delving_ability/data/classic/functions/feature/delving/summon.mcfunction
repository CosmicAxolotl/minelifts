...
summon block_display ~ ~ ~ {block_state:{Name:"minecraft:air"},UUID:[I;0,0,32,5],Passengers:[{id:"minecraft:block_display",block_state:{Name:"minecraft:air"},view_range:0.0f,Tags:["indicator_anchor"],Passengers:[{background:0,shadow:1b,id:"minecraft:text_display",alignment:"center",text:'{"text":"???","color":"#FCF000"}',Tags:["indicator.num","num.down"],billboard:"vertical",Rotation:[0.0f,90.0f],brightness:{sky:0,block:15},view_range:0.1f},{background:0,shadow:1b,id:"minecraft:text_display",alignment:"center",text:'{"text":"???","color":"#FCF000"}',Tags:["indicator.num","num.up"],billboard:"vertical",Rotation:[0.0f,-90.0f],brightness:{sky:0,block:15},view_range:0.1f},{background:0,shadow:1b,id:"minecraft:text_display",alignment:"center",text:'{"text":"???","color":"#FCF000"}',Tags:["indicator.num","num.east"],billboard:"fixed",Rotation:[-90.0f,0.0f],brightness:{sky:0,block:15},view_range:0.1f},{background:0,shadow:1b,id:"minecraft:text_display",alignment:"center",text:'{"text":"???","color":"#FCF000"}',Tags:["indicator.num","num.west"],billboard:"fixed",Rotation:[90.0f,0.0f],brightness:{sky:0,block:15},view_range:0.1f},{background:0,shadow:1b,id:"minecraft:text_display",alignment:"center",text:'{"text":"???","color":"#FCF000"}',Tags:["indicator.num","num.south"],billboard:"fixed",Rotation:[0.0f,0.0f],brightness:{sky:0,block:15},view_range:0.1f},{background:0,shadow:1b,id:"minecraft:text_display",alignment:"center",text:'{"text":"???","color":"#FCF000"}',Tags:["indicator.num","num.north"],billboard:"fixed",Rotation:[-180.0f,0.0f],brightness:{sky:0,block:15},view_range:0.1f},{id:"minecraft:block_display",billboard:"fixed",brightness:{sky:0,block:15},block_state:{Name:"minecraft:spawner"},view_range:0.1f,Tags:["indicator"]},{id:"minecraft:villager",NoAI:1b,Age:-2147483648,CustomName:'{"text":"Jerry"}',Team:"no_collisions",Silent:1b,Invulnerable:1b,DeathLootTable:"minecraft:empty",ActiveEffects:[{Id:14,ShowParticles:0b,Ambient:0b,Duration:2147483647}],Tags:["tmp","connector"],Passengers:[{id:"minecraft:marker"},{id:"minecraft:area_effect_cloud",Age:-2147483648,Duration:-1,WaitTime:-2147483648,Passengers:[{id:"minecraft:area_effect_cloud",Age:-2147483648,Duration:-1,WaitTime:-2147483648}]}]}]}]}
