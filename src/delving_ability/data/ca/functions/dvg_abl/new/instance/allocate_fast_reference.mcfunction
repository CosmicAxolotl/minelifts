...
execute unless entity @a[predicate=ca:dvg_abl/private/fast_reference,limit=1] store result score @s ca.dvg_abl.fun run data get storage ca:ram stack[-1].id 
