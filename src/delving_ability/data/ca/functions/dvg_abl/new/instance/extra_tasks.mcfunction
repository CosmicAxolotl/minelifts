...
$scoreboard players operation $(interaction) ca.dvg_abl.fun = @s ca.dvg_abl.fun
...
$scoreboard players operation $(wind_rose) ca.dvg_abl.fun = @s ca.dvg_abl.fun

$tag $(interaction) add dvg_abl.interaction
$tag $(vehicle) add dvg_abl.vehicle
$tag $(cage) add dvg_abl.cage
$tag $(tail) add dvg_abl.tail
$tag $(wind_rose) add dvg_abl.wind_rose
