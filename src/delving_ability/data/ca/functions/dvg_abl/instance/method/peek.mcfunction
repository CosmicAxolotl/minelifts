...
$execute as $(wind_rose) on passengers run data modify entity @s view_range set value 0.0f
$execute as $(wind_rose) run data modify entity @s view_range set value 0.0f
...
$execute as $(interaction) run data modify entity @s {} merge value {height:0.0f,width:0.0f}
