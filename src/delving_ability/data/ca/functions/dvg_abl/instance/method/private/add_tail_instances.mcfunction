...
execute if data storage ca:ram protected_stack[-1][-1].move{direction:"east"} run scoreboard players set #$move.z ca.dvg_abl.fun 1
execute if data storage ca:ram protected_stack[-1][-1].move{direction:"west"} run scoreboard players set #$move.z ca.dvg_abl.fun 1
execute if data storage ca:ram protected_stack[-1][-1].move{direction:"down"} run scoreboard players set #$move.z ca.dvg_abl.fun 1
execute if data storage ca:ram protected_stack[-1][-1].move{direction:"up"} run scoreboard players set #$move.z ca.dvg_abl.fun 1
...
function ca:gnr_lay/remove/int
