...
execute if predicate ca:gnr/input/move/forward on vehicle run function ca:dvg_abl/action/crouch
...
execute anchored eyes positioned ^ ^ ^ positioned ~ ~0.5 ~ run function ca:dvg_abl/instance/task/controls
