...
$execute as $(cage) on passengers if entity @s[tag=not_a_face,tag=!select.face] run function ca:dvg_abl/method/cage/update_inside_block with storage ca:ram stack[-2].pivot_pos
